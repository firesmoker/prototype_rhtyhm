...
@onready var beliver: Node2D = $"../../Believer"
@onready var BabyShark: Node2D = $"../../BabyShark"
@onready var BabySharkHarder: Node2D = $"../../BabySharkHarder"
@onready var DanceMonkey: Node2D = $"../../DanceMonkey"
@onready var DanceMonkeyHarder: Node2D = $"../../DanceMonkeyHarder"
@onready var CountingStars: Node2D = $"../../CountingStars"
@onready var BelieverHarder: Node2D = $"../../BelieverHarder"
@onready var level6: Node2D = $"../../CowboysFromHell"
@onready var level7: Node2D = $"../../Level"
